...
-- Projects grouping multiple tasks (optionally)
create table projects (
  ...
  created_at     timestamp default systimestamp not null,
  assigned_tl_id number references users(user_id),
  status_code    varchar2(20) default 'NEW' not null,
  constraint projects_status_ck check (status_code in ('NEW','IN_PROGRESS','READY_FOR_REVIEW','APPROVED','REJECTED','CANCELLED'))
);
